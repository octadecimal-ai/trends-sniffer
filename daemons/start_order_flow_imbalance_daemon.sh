#!/bin/bash
# ============================================================================
# Order Flow Imbalance Daemon - Start Script
# ============================================================================
# Skrypt do zarządzania daemonem obliczającym metryki Order Flow Imbalance
# ============================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"
PID_FILE="$PROJECT_ROOT/.dev/logs/order_flow_imbalance_daemon.pid"
LOG_FILE="$PROJECT_ROOT/.dev/logs/order_flow_imbalance_daemon.log"
DAEMON_SCRIPT="$PROJECT_ROOT/daemons/order_flow_imbalance_daemon.py"
...
start_daemon() {
    ...
    echo "🚀 Uruchamianie Order Flow Imbalance Daemon..."
    cd "$PROJECT_ROOT"

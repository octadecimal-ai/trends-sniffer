...
PYTHON_SCRIPT="${SCRIPT_DIR}/dydx_top_traders_observer.py"
LOG_FILE="${PROJECT_DIR}/.dev/logs/dydx_top_traders_observer.log"
PID_FILE="${PROJECT_DIR}/.dev/dydx_top_traders_observer.pid"

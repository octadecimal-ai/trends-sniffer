...
PYTHON_SCRIPT="${SCRIPT_DIR}/src/scripts/dydx_perpetual_market_trades_daemon.py"
LOG_FILE="${SCRIPT_DIR}/.dev/logs/dydx_perpetual_market_trades_service.log"
PID_FILE="${SCRIPT_DIR}/.dev/dydx_perpetual_market_trades_service.pid"
